...
/**
 * \file    core/triggers/interface_99_modTest_1_Test_1Triggers.class.php
 * \ingroup test_1
 ...
 *      - interface_99_modTest_1_MyTrigger.class.php
...
/**
 *  Class of triggers for Test_1 module
 */
class InterfaceTest_1Triggers extends DolibarrTriggers
{
	/**
	 * Constructor
	 *
	...
	public function __construct($db)
	{
		...
		$this->family = "demo";
		$this->description = "Test_1 triggers.";
		$this->version = self::VERSIONS['dev'];
		$this->picto = 'test_1@test_1';
	}
