...
/**
 *  \file       core/modules/test_1/doc/pdf_standard.modules.php
 *  \ingroup    test_1
...
/**
 *	Class to manage PDF template standard_test
 */
class pdf_standard_test extends ModelePDFTEST
{
	/**
	 ...
	 *
	 *  @param		TEST	$object				Object to generate
	 ...
	 *
	 *  @param	TCPDF		$pdf     		Object PDF
	 *  @param  TEST	$object     	Object to show
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		// Show Draft Watermark
		if (getDolGlobalString('TEST_1_DRAFT_WATERMARK') && $object->statut == $object::STATUS_DRAFT) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('TEST_1_DRAFT_WATERMARK')));
		}
